...
const telRegex = RegExp('^\\([1-9]{2}\\) (?:[2-8]|9[0-9])[0-9]{3}\\-[0-9]{4}$', 'gm');
    ...
    <div className="wrapper bg-primary">
      <div className="min-h-screen flex items-center justify-center">
        <div className="w-full max-w-md">
          <h3 style={{ marginTop: '20px' }} className="text-2xl font-bold mb-6 text-center">Cadastro Neurodiverso</h3>
          <div className="bg-white shadow-md rounded-md p-6">
            <form onSubmit={handleSubmit} className="cadastro-form">
              ...
              <div className="mb-4">
                <label className="block text-gray-600">Divergencia <span className="text-red-500">*</span></label>
                <input
                  type="text"
              ...
              <div className="mb-4">
                <label className="block text-gray-600">Telefone <span className="text-red-500">*</span></label>
                <IMaskInput
                  type="tel"
